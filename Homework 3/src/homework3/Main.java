...
//        }
        ...
        System.out.println("Ваш массив: "+ Arrays.toString(arr5));
        ob.shakerSort(arr5);
        System.out.println("Отсортированный массив: "+ Arrays.toString(arr5));
        System.out.println("Массив без дубликатов: "+ Arrays.toString(ob.deleteDublicat(arr5)));
    }
}
